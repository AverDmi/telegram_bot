...
import com.dimthomas.service.enums.ServiceCommands;
...
import static com.dimthomas.entity.enums.UserState.BASIC_STATE;
import static com.dimthomas.entity.enums.UserState.WAIT_FOR_EMAIL_STATE;
import static com.dimthomas.service.enums.ServiceCommands.*;
...
public class MainServiceImpl implements MainService {
    ...
    private boolean isNotAllowToSendContent(Long chatId, AppUser appUser) {
        ...
        if(!appUser.getIsActive()) {
            var error = "Зарегистрируйтесь или активтруйте свою учетную запись для загрузки контента";
            sendAnswer(error, chatId);
            return true;
        } else if (!BASIC_STATE.equals(userState)) {
    ...
    private String processServiceCommand(AppUser appUser, String cmd) {
        if(REGISTRATION.equals(cmd)) {
            ...
            return "Приветствую! Чтобы постмотреть список доступных команд, введите /help";
        } else {
            return "Неизвестная команда! Чтобы постмотреть список доступных команд, введите /help";
        }
    }
